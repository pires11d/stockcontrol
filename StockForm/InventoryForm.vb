...
Public Class InventoryForm
    ...
    Public Sub LoadTreeViews()
        ...
        Next
        tvB.ExpandAll()
        tvB.Nodes.Item(0).EnsureVisible()
        ...
        Next
        tvC.ExpandAll()
        tvC.Nodes.Item(0).EnsureVisible()
    ...
    Private Sub btnEditBarrel_Click(sender As Object, e As EventArgs) Handles btnEditBarrel.Click
        Try
            Dim editBarrelForm As New InventoryAddForm(Item.Kinds.Barril, Main.barrels(lblID.Text))
            editBarrelForm.Show()
        Catch ex As Exception
        End Try
    End Sub

    Private Sub btnEditCooler_Click(sender As Object, e As EventArgs) Handles btnEditCooler.Click
        Try
            Dim editCoolerForm As New InventoryAddForm(Item.Kinds.Chopeira, Main.coolers(lblID.Text))
            editCoolerForm.Show()
        Catch ex As Exception
        End Try
    End Sub
